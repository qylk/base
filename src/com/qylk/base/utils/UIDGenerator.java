...
public abstract class UIDGenerator {
    ...
    private final static UIDGenerator generator = new UIDGenerator4();
    ...
    private static final class UIDGenerator4 extends UIDGenerator {

        private final UIDGenerator generator = new UIDGenerator3();
        private final String prefix;

        public UIDGenerator4() {
            int n = (int) ((System.currentTimeMillis() / 1000) % 100000000);
            int length = ELEMENTS.length();
            StringBuilder sb = new StringBuilder();
            do {
                sb.insert(0, ELEMENTS.charAt(n % length));
                n /= length;
            } while (n >= length);
            prefix = sb.toString();
        ...
        @Override
        public String nextUID() {
            return prefix + generator.nextUID();
        }
    }
}